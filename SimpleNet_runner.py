...
import datetime
from SimpleNet_dataset import VqaDataset
import numpy as np
from SimpleNet import SimpleBaselineNet


class SimpleBaselineExperimentRunner(object):
    def __init__(self, train_image_dir, train_question_path, train_annotation_path,
        ...
        self._model = SimpleBaselineNet(len(train_D.SetQdict)+1000, len(train_D.SetAdict)).cuda()
        ...
        self.optim = torch.optim.Adam(self._model.parameters(), lr=0.001)
    ...
    def _optimizer(self, predicted_answers, true_answer_ids):
    ...
    def train(self):
        ...
        for epoch in range(self._num_epochs):
            ...
            PathforModel = './savedmodels/simplenet/modelat_'+str(epoch)
            ...
            for batch_id, batch_data in enumerate(self._train_dataset_loader):
                ...
                loss = self._optimizer(predicted_answer, ground_truth_answer.cuda())
